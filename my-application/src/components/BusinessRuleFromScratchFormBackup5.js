...
class BusinessRuleFromScratchForm extends React.Component {
    ...
    constructor(props) {
        ...
        // if (this.state.selectedTemplateGroup.name != '') {
    ...
    render() {
        ...
        // Update helper text for template groups
        if (isATemplateGroupSelected) {
        ...
        if (isATemplateGroupSelected) {
            ...
            outputMappings = [] // Key: input Value: output
            ...
            } else if (this.state.formMode === BusinessRulesConstants.BUSINESS_RULE_FORM_MODE_CREATE) {
                if (isATemplateGroupSelected) {
                    // todo: derive fields for outputMapping, from input exposed stream definition
                    outputMappingsToDisplay = <TableRow><TableCell>To be Implemented</TableCell></TableRow>
                }
            }
        } else {
            outputRuleTemplatesToDisplay = <div></div>
            outputDataPropertiesToDisplay = <div></div>
            outputMappingsToDisplay = <TableRow><TableCell>Please select an input rule template</TableCell></TableRow>
        }
